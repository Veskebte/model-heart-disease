...
# Load data  # Memuat dataset heart dari file CSV yang berisi informasi pasien dan hasil pemeriksaan heart.
data = pd.read_csv('heart.csv')  # Membaca data dari file 'heart.csv' menggunakan pandas.
...
with open('heart_disease_classification_model.pkl', 'wb') as file:  # Membuka file 'model.pkl' dalam mode write-byte.
